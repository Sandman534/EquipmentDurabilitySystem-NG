...
namespace EDPapyrus {
    ...
    bool IsGearEquipped(RE::StaticFunctionTag*, RE::TESForm* item, std::uint32_t fixedItemID, std::uint32_t slotID) {
        //=========================================================
        // Status Checks
        //=========================================================
    ...
    std::uint32_t UpdatedItemID(RE::StaticFunctionTag*, RE::TESForm* item, std::uint32_t fixedItemID) {
        //=========================================================
        // Status Checks
        //=========================================================
    ...
    GearData GetGearData(RE::BSSimpleList<RE::InventoryEntryData*> &entryLists, RE::TESForm* item, std::uint32_t fixedItemID) {
        ...
        RE::TESBoundObject* FoundItem = nullptr;
        ...
        if (FoundLists.size() <= 0 || !FoundItem) return GearData { nullptr, nullptr, 0 };
